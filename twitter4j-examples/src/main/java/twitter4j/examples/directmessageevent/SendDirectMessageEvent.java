 ...
 */
public final class SendDirectMessageEvent {
    /**
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: java twitter4j.examples.directmessage.SendDirectMessage [recipient user id] [message]");
            System.exit(-1);
        }
        Twitter twitter = new TwitterFactory().getInstance();
        try {
            DirectMessageEvent message = twitter.sendDirectMessageEvent(Long.valueOf(args[0]), args[1]);
