...
rm twitter4j-gae/src/test/resources/twitter4j.properties
...
sed -i '' "s/<url>http:\/\/oss.sonatype.org\/service\/local\/staging\/deploy\/maven2\//<url>file:\/Users\/yusukey\/maven2\//g" twitter4j-gae/pom.xml
...
sed -i '' "s/-SNAPSHOT\";/-SNAPSHOT\(build: $HASH\)\";/g" twitter4j-gae/src/main/java/twitter4j/VersionGAE.java
...
mkdir $DIR/twitter4j-gae
cp -r twitter4j-gae/src $DIR/twitter4j-gae/
cp twitter4j-gae/pom.xml $DIR/twitter4j-gae/
...
mkdir $DIR/twitter4j-gae/javadoc/
unzip twitter4j-gae/target/twitter4j-gae-$1-javadoc.jar -d $DIR/twitter4j-gae/javadoc/
cp twitter4j-gae/target/twitter4j-gae-$1-javadoc.jar -d $DIR/twitter4j-gae/
cp twitter4j-gae/target/twitter4j-gae-$1-sources.jar -d $DIR/twitter4j-gae/
...
cp twitter4j-gae/target/twitter4j-gae-$1.jar $DIR/lib
