...
sed -i "" 's/package twitter4j;/\/\/ generated with generate-lazy-objects.sh\
package twitter4j.internal.json;\
\
import twitter4j.*;/g' $TARGET
...
\
    LazyXXX(twitter4j.internal.http.HttpResponse res, Factory factory) {\
        this.res = res;\
...
#cp tweets/destroyStatus.sh $1/$2.sh
#mkdir -p ../src/main/java/twitter4j/examples/$1
#cp ../src/main/java/twitter4j/examples/tweets/DestroyStatus.java ../src/main/java/twitter4j/examples/$1/$3.java

#tweets.UpdateStatus
#sed -i "" "s/tweets.DestroyStatus/$1.$3/g" $1/$2.cmd
#sed -i "" "s/tweets.DestroyStatus/$1.$3/g" $1/$2.sh
#sed -i "" "s/class DestroyStatus/class $3/g" ../src/main/java/twitter4j/examples/$1/$3.java
#sed -i "" "s/package twitter4j.examples.tweets/package twitter4j.examples.$1/g" ../src/main/java/twitter4j/examples/$1/$3.java
#sed -i "" "s/twitter4j.examples.tweets.DestroyStatus/twitter4j.examples.$1.$3/g" ../src/main/java/twitter4j/examples/$1/$3.java
