...
package org.twitter4j.core.internal.logging;
...
public abstract class Logger {
    ...
    static {
        ...
        // -Dtwitter4j.debug=true -Dtwitter4j.loggerFactory=org.twitter4j.core.internal.logging.StdOutLoggerFactory
        ...
        // loggerFactory=org.twitter4j.core.internal.logging.StdOutLoggerFactory
        ...
        if (null == loggerFactory) {
            loggerFactory = getLoggerFactoryIfAvailable("org.slf4j.impl.StaticLoggerBinder", "org.twitter4j.core.internal.logging.SLF4JLoggerFactory");
        }
        // otherwise, use commons-logging if it's found in the classpath
        if (null == loggerFactory) {
            loggerFactory = getLoggerFactoryIfAvailable("org.apache.commons.logging.Log", "org.twitter4j.core.internal.logging.CommonsLoggingLoggerFactory");
        }
        // otherwise, use log4j if it's found in the classpath
        if (null == loggerFactory) {
            loggerFactory = getLoggerFactoryIfAvailable("org.apache.log4j.Logger", "org.twitter4j.core.internal.logging.Log4JLoggerFactory");
        }
        // on Google App Engine, use java.twitter4j.JULogger
        if (null == loggerFactory) {
            loggerFactory = getLoggerFactoryIfAvailable("com.google.appengine.api.urlfetch.URLFetchService", "org.twitter4j.core.internal.logging.JULLoggerFactory");
        }
