...
public class TwitterFactory implements java.io.Serializable {
    ...
    static {
        ...
        if (gaeDetected) {
            final String APP_ENGINE_TWITTER_IMPL = "org.twitter4j.appengine.AppEngineTwitterImpl";
            try {
        ...
        if (className == null) {
            className = "org.twitter4j.core.TwitterImpl";
        }
     ...
     * Unlike {@link Twitter#setOAuthAccessToken(org.twitter4j.core.auth.AccessToken)}, this factory method potentially returns a cached instance.
     *
