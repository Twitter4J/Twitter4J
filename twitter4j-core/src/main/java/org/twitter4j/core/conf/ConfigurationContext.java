 ...
 * By default, org.twitter4j.core.conf.PropertyConfigurationFactory will be used and can be changed with -Dtwitter4j.configurationFactory system property.
 *
 * @author Yusuke Yamamoto - yusuke at mac.com
 */
public final class ConfigurationContext {
    private static final String DEFAULT_CONFIGURATION_FACTORY = "org.twitter4j.core.conf.PropertyConfigurationFactory";
