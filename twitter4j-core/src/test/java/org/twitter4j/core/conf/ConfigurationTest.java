...
public class ConfigurationTest extends TestCase {
    ...
    public void testConfiguration() throws Exception {
        ...
        System.getProperties().remove("org.twitter4j.core.http.proxyHost");
        conf = new PropertyConfiguration();
        assertEquals(null, conf.getHttpClientConfiguration().getHttpProxyHost());

        System.setProperty("org.twitter4j.core.http.proxyHost", override);
        conf = new PropertyConfiguration();
        assertEquals(override, conf.getHttpClientConfiguration().getHttpProxyHost());
        System.getProperties().remove("org.twitter4j.core.http.proxyHost");

        System.getProperties().remove("org.twitter4j.core.http.proxyPort");
        conf = new PropertyConfiguration();
        assertEquals(-1, conf.getHttpClientConfiguration().getHttpProxyPort());

        System.setProperty("org.twitter4j.core.http.proxyPort", "100");
        conf = new PropertyConfiguration();
        assertEquals(100, conf.getHttpClientConfiguration().getHttpProxyPort());
        System.getProperties().remove("org.twitter4j.core.http.proxyPort");


        System.getProperties().remove("org.twitter4j.core.http.proxyUser");
        conf = new PropertyConfiguration();
        assertEquals(null, conf.getHttpClientConfiguration().getHttpProxyUser());

        System.setProperty("org.twitter4j.core.http.proxyUser", override);
        conf = new PropertyConfiguration();
        assertEquals(override, conf.getHttpClientConfiguration().getHttpProxyUser());
        System.getProperties().remove("org.twitter4j.core.http.proxyUser");


        System.getProperties().remove("org.twitter4j.core.http.proxyPassword");
        conf = new PropertyConfiguration();
        assertEquals(null, conf.getHttpClientConfiguration().getHttpProxyPassword());

        System.setProperty("org.twitter4j.core.http.proxyPassword", override);
        conf = new PropertyConfiguration();
        assertEquals(override, conf.getHttpClientConfiguration().getHttpProxyPassword());
        System.getProperties().remove("org.twitter4j.core.http.proxyPassword");


        System.getProperties().remove("org.twitter4j.core.http.connectionTimeout");
        conf = new PropertyConfiguration();
        ...
        System.setProperty("org.twitter4j.core.http.connectionTimeout", "100");
        conf = new PropertyConfiguration();
        ...
        System.getProperties().remove("org.twitter4j.core.http.readTimeout");
        conf = new PropertyConfiguration();
        ...
        System.setProperty("org.twitter4j.core.http.readTimeout", "100");
        conf = new PropertyConfiguration();
        ...
        writeFile("./twitter4j.properties", "org.twitter4j.core.http.readTimeout=1234");
        conf = new PropertyConfiguration();
        assertEquals(1234, conf.getHttpClientConfiguration().getHttpReadTimeout());
        writeFile("./twitter4j.properties", "org.twitter4j.core.http.readTimeout=4321");
        conf = new PropertyConfiguration();
    ...
    public void testSSL() throws Exception {
        ...
        // uses SSL by default
        System.getProperties().remove("org.twitter4j.core.http.useSSL");
