...
package org.twitter4j.core.internal.json;
...
public final class CategoryJSONImpl implements Category, java.io.Serializable {
    ...
    public static ResponseList<Category> createCategoriesList(JSONArray array, HttpResponse res, Configuration conf) throws TwitterException {
        try {
