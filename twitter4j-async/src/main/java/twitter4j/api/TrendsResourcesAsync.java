...
public interface TrendsResourcesAsync {
     ...
     * <br>This method calls http://api.twitter.com/1.1/trends/:woeid.json
     *
     * @param woeid The WOEID of the location to be querying for
     * @see <a href="https://dev.twitter.com/docs/api/1.1/get/trends/:woeid">GET trends/:woeid | Twitter Developers</a>
     * @since Twitter4J 2.1.1
     */
